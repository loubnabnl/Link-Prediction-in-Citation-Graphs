...
def main(args):
    ...
    if args.model == "xgboost":
        ...
        raise ValueError('Invalid classification model name')
...
if __name__ =="__main__":
    ...
    parser.add_argument("--authors", type=str, default="data/authors.txt", 
        help="Path to the author  text file")
    parser.add_argument("--path_test", type=str, default="data/test.txt", 
        help="Path to the test file")
    parser.add_argument("--abstract_path", type=str, default="embeddings/abstract_embeddings.emb",
                        help="Path to the abstract embeddings")
    parser.add_argument("--nodes_path", type=str, default="embeddings/node_embeddings.emb", 
        help="Path to the node embeddings")
    parser.add_argument("--authors_path", type=str, default="embeddings/authors_embeddings.emb", 
